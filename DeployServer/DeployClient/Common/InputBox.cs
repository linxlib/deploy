    ...
    public class InputBox
    {
        ...
        private class dialogForm : Form
        {
            ...
            public dialogForm(string title, InputBoxItem[] items, InputBoxButtons buttons)
            {
                ...
                button1.Location = new Point(208, 40 + (39 * label.Length));
                ...
                button2.Location = new Point(110, 40 + (39 * label.Length));
                ...
                button3.Location = new Point(12, 40 + (39 * label.Length));
                ...
                ClientSize = new Size(312, 200 + (39 * items.Length));
                for (int i = 0; i < label.Length; i++)
                {
                ...
                MaximizeBox = false;
                MinimizeBox = false;
                MaximumSize = new Size(99999, 150 + (39 * items.Length));
                Name = "dialogForm";
                ShowIcon = false;
                ShowInTaskbar = false;
                Text = title;
